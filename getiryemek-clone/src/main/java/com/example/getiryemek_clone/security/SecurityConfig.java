        ...
        return http
                ...
                .authorizeHttpRequests( x->
                        x.requestMatchers("/api/admin/login").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET,"/api/email-deneme").permitAll()
                                .requestMatchers("/api/create-password").permitAll()
                                .requestMatchers("/api/reset-password").permitAll()
                                .requestMatchers(HttpMethod.POST,"/api/restaurantAdmin").permitAll()
